    ...
    <div class="col-12 col-lg-6 my-3 cardReservation">
        <div>
            ...
            <div class="d-flex row flex-wrap justify-content-between">
                <a href="./Dashboard.php?action=AcceptReservation&id_reservation=<?= $result->getId_reservation() ?>"
                    class="btn-blue col-5 mb-2 text-center">Reserve
                </a>
                <a href="./Dashboard.php?action=cancelReservation&id_reservation=<?= $result->getId_reservation() ?>&link=ActiveReservations"
