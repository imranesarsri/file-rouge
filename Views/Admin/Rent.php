...
$action = "";
$enctype = "";
$headerSection = "Available Cars for Rent";
ob_start();
?>
<table>
    <tr>
    ...
    foreach ($results as $result) {
        ...
        <tr>
            ...
            <td class="btn-table">
                <a href="./dashboard.php?action=Delete&id_car=<?= $result->getCar_id() ?>&type=<?= $result->getType() ?>"
                    class="btn-red m-1"><i class="fa-solid fa-trash-can"></i></a>
